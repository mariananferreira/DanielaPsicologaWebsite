...
function TopBar() {
  ...
  return (
    ...
    >
      <div className="mx-auto flex max-w-screen-xl items-center justify-between space-x-6">
        {/* Espaço vazio para alinhamento à direita */}
        <div className="flex-grow"></div>
        {/* Horário com ícone de relógio (alinhado à direita) */}
        <div className="flex items-center justify-end space-x-2">
          <ClockIcon className="h-5 w-5 text-slate-700" />
          <span>De terça a sábado</span>
        </div>
        {/* Email com ícone de envelope (alinhado à direita) */}
        <div className="flex items-center justify-end space-x-2">
